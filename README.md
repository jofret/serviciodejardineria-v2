...
- [x] **Fase 8** — corte de DNS/dominio. Verificado en el servidor el 2026-08-13: `public_html` de `serviciodejardineria.com.ar` ya apunta a la app de este repo (`new_release_20260805f`), sirviendo tráfico real (ver `INFRAESTRUCTURA.md`). El corte había pasado alrededor del 5-6/8; este checkbox había quedado sin actualizar.
