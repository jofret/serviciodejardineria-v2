...
use CoodectTechnologies\Honey\Checks\JavascriptInputFilledCheck;
use CoodectTechnologies\Honey\Checks\MinimumTimePassedCheck;
use CoodectTechnologies\Honey\Checks\PresentButEmptyCheck;
use CoodectTechnologies\Honey\Checks\UserIsBlockedSpammerCheck;
use CoodectTechnologies\Honey\Features;
use CoodectTechnologies\Honey\InputNameSelectors\StaticInputNameSelector;
...
//        Features::neverGonnaGiveYouUp(),
     ...
     *
     * @see \CoodectTechnologies\Honey\Checks\Check
     */
    'checks' => [
     ...
     */
    'input_values' => [
        'javascript' => CoodectTechnologies\Honey\InputValues\JavascriptInputValue::class,
        'time_of_page_load' => CoodectTechnologies\Honey\InputValues\TimeOfPageLoadValue::class,
    ],
